...
/*   Updated: 2025/07/28 00:24:06 by moel-hib         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*routini(void *tmp)
{
	...
	while (!le_philo->data->dead_flag)
	{
		...
		usleep(le_philo->data->tm_eat * 1000);
		...
		usleep(le_philo->data->tm_sleep * 1000);
//
//		if (le_philo->philo_id % 2 == 0)
//		{
//			if (le_philo->data->tm_eat > le_philo->data->tm_sleep)
//				usleep((le_philo->data->tm_eat) * 1000);
//			//usleep(3000);
//		}
